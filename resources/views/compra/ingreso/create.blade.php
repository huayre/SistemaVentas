...
@section ('contenido')
 <div class="row">
  ...
  <form action="{{route('ingreso.store')}}" method="post" autocomplete="off">
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                     <div class="form-group">
                         ...
                         <input type="text" name="serie_comprobante"  class="form-control" placeholder="Serie del Comprobante..">
                    </div>
                </div>
            ...
            <!--vista param los detalles de label venta-->
            <div class="row">
         ...
         <script>
              ...
              function agregar(){
                ...
                //validar que las cajas y selectores no esten vacidos
              ...
              //ocultar eliminar boton de guardar
              function evaluar()
              {
                if (total>0)
                {
               ...
               //eliminar un registro de la compra

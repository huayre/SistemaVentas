 <form action="{{route('venta.index')}}" method="get"  role="busqueda" autocomplete="off">
        ...
        <div class="input-group">
            ...
            <span class="input-group-btn">
                ...
                <button type="submit" class="btn btn-primary">
                 Buscar</button><!--se envia lo que se esc
ribe en la caja de texto a almacen categoria que a su vez llama al metodo index en la linea 21 y realiza el filtro con la palabra-->

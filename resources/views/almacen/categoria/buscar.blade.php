 ...
 <form action="{{route('categoria.index')}}" method="get"  role="busqueda" autocomplete="off">
    ...
    <div class="form-group">
        <div class="input-group">
            ...
            <span class="input-group-btn">
                <!--Para que el boton salga justo al lado de la caja de texto-->
                <button type="submit" class="btn btn-primary">
                 Buscar</button><!--se envia lo que se escribe en la caja de texto a almacen categoria que a su vez llama al metodo index en la linea 21 y realiza el filtro con la palabra-->
